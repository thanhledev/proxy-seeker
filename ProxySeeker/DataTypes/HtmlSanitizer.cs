...
namespace ProxySeeker.DataTypes
{
    public static class HtmlSanitizer
    {
        ...
        new Dictionary<string, string[]>
        {
            ...
            {"p", new string[]          {"style", "align"}},
            {"div", new string[]        {"style"}},
            ...
            {"ul", new string[]         {"style"}},
            {"li", new string[]         {"style"}},
            {"blockquote", new string[] {"style"}},
            {"code", new string[]       {"style"}},
             
            {"img", new string[]        { "src", "alt", "title"}},
 
            {"table", new string[]      {"style", "border", "cellspacing", "cellpadding", "rules", "bordercolor"}},
            {"thead", new string[]      {"style"}},
            {"tbody", new string[]      {"style"}},
            {"tfoot", new string[]      {"style"}},
            {"th", new string[]         {"style", "scope"}},
            {"tr", new string[]         {"style"}},
            {"td", new string[]         {"style", "align", "colspan"}}
        };
